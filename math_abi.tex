...
\begin{split}
f(x) = \sqrt{9 - x^2}\\
V = \pi * \int_{-3}^3 (f(x)^2)\ dx\\
V = \pi * \int_{-3}^3 (\sqrt{9 - x^2})^2)\ dx\\
V = \pi * \int_{-3}^3 (9 - x^2)\ dx\\
V = \pi * \Bigg{[}9x - \frac{3^x}{3}\Bigg{]}_{-3}^{3} dx\\
V = \pi * \Bigg{[}\Bigg{(}9 * 3 - \frac{3^3}{3}\Bigg{)} - \Bigg{(}9 * -3 - \frac{(-3)^3}{3}\Bigg{)}\Bigg{]}\\
V = \pi * \Bigg{[}\Bigg{(} 27 - \frac{27}{3} \Bigg{)} - \Bigg{(} -27 - \frac{-27}{3} \Bigg{)}\Bigg{]}\\
V = \pi * [(27 - 9) - (-27 + 9)]\\
V = \pi * [18 + 18] = \underline{\underline{36\pi}}\\
\end{split}    
\end{equation}
\pagebreak
